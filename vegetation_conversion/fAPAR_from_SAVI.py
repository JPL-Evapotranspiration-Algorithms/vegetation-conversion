...
def fAPAR_from_SAVI(SAVI: Union[Raster, np.ndarray]) -> Union[Raster, np.ndarray]:
    ...
    The result is clipped to the range [0, 1] to ensure physically valid values.

    Reference:
        Fisher, J. B., et al. (2008). The land surface water and energy budget of the western
        United States based on MODIS satellite data. Water Resources Research, 44(9), W09422.
        https://doi.org/10.1029/2007WR006057
